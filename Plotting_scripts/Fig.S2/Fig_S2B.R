...
setwd('E:/experiment/MH63')

# Read the data from the file
data_gatk  <- read.csv('GATK_MH63_repeattimecount.txt', sep = '\t')
data_hip <- read.csv('hipSTR_MH63_repeattimecount.txt', sep = '\t')
data_lob <- read.csv('lobSTR_MH63_repeattimecount.txt', sep = '\t')
